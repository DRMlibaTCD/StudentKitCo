...
- **Botswana is now fully unlocked** — 7 institutions (University of Botswana, Ba Isago, Botho, BIUST, Limkokwing Botswana, BAC, ISBS) with real official site links, Botswana-specific sample opportunities referencing DTEF and local institutions, and a "Tertiary Funding" card on the Profile screen linking to the Department of Tertiary Education Financing (tef.gov.bw). South Africa, Lesotho and Zambia remain locked/"Coming soon".
